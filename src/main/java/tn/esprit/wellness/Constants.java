...
public class Constants {
    ...
    public static final String EMAIL_ENDPOINT = "https://api.linkedin.com/v2/clientAwareMemberHandles?q=members&projection=(elements*(primary,type,handle~))";
    public static final String PROFILE_IMG_ENDPOINT = "https://api.linkedin.com/v2/me?projection=(id,profilePicture(displayImage~:playableStreams))";
