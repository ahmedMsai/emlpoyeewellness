...
import tn.esprit.wellness.builder.AuthorizationUrlBuilder;
import tn.esprit.wellness.builder.ScopeBuilder;
import tn.esprit.wellness.pojo.AccessToken;
import tn.esprit.wellness.util.Constants;
import tn.esprit.wellness.util.Preconditions;

import java.io.IOException;


import static tn.esprit.wellness.Constants.USER_AGENT_OAUTH_VALUE;
import static tn.esprit.wellness.util.Constants.*;
